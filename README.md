...
1. Ingestion & Vectorization (updated_ingest.py)
...
2. Retrieval & Inference (new_rag_terminal.py)
...
├── my_chroma_db/           # Auto-generated vector database (Do not create manually)
├── updated_ingest.py       # Script to build the vector database
├── new_rag_terminal.py     # Terminal interface to chat with the AI
└── README.md
